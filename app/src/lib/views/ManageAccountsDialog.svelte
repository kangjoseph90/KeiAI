                ...
                >
                    <div class="flex items-center gap-3 overflow-hidden">
                        <Avatar.Root class="size-10">
                            ...
                            <Avatar.Fallback
                                >{(u.name || 'U').charAt(0).toUpperCase()}</Avatar.Fallback
                            >
                        </Avatar.Root>
            ...
            <AlertDialog.Description>
                ...
                {:else}
                    <div class="mt-4 p-3 bg-muted text-muted-foreground rounded-md text-sm">
                        This will only remove the account from this device. Your server data remains
                        intact and can be restored by logging in again.
                    </div>
                {/if}
            </AlertDialog.Description>
        </AlertDialog.Header>
