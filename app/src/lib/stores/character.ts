...
export async function selectCharacter(characterId: string) {
	...
	if (!detail) throw new Error('Failed to load character detail: Character not found or deleted.');
...
export async function updateCharacterSummary(
	...
	if (!updated) throw new Error('Failed to update character summary.');
...
export async function updateCharacterData(
	...
	if (!updated) throw new Error('Failed to update character data.');
